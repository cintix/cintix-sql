...
export function EditorPanel() {
  ...
  const handleMount: OnMount = useCallback((editor, monaco) => {
    ...
    monaco.editor.defineTheme('cintix-dark', {
      ...
      colors: {
        'editor.background': '#2e2d2d',
        'editor.foreground': '#e8e6e3',
        'editor.lineHighlightBackground': '#343333',
        'editor.selectionBackground': '#5a3580',
        'editor.inactiveSelectionBackground': '#3d3c3c',
        'editorCursor.foreground': '#c792ea',
        'editorLineNumber.foreground': '#706e6d',
        'editorLineNumber.activeForeground': '#a09e9d',
